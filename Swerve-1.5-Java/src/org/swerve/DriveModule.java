...
public class DriveModule {
	...
	public DriveModule(int speedPort, int anglePort, int encoder1Port, int encoder2Port, int potPort, PIDValue PIDAngleValues, PIDDriveValue PIDDriveValues, PIDDistance PIDDistanceValues, float angleOffset, String name) {
