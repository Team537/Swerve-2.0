...
public class SwerveComponent extends IComponent {
	...
	public SwerveComponent(Gyro gyro) {
		this.FLModule = new DriveModule(11, 15, 16, 17, 5, Schematic.PID_FRONT_LEFT_ANGLE, Schematic.PID_FRONT_LEFT_DRIVE, Schematic.PID_FRONT_LEFT_DISTANCE, 0, "Front Left");
		this.FRModule = new DriveModule(12, 16, 23, 22, 6, Schematic.PID_FRONT_RIGHT_ANGLE, Schematic.PID_FRONT_RIGHT_DRIVE, Schematic.PID_FRONT_RIGHT_DISTANCE, 0, "Front Right");
		this.BLModule = new DriveModule(10, 14, 14, 15, 4, Schematic.PID_BACK_LEFT_ANGLE, Schematic.PID_BACK_LEFT_DRIVE, Schematic.PID_BACK_LEFT_DISTANCE, 0, "Back Left");
		this.BRModule = new DriveModule(13, 17, 24, 25, 7, Schematic.PID_BACK_RIGHT_ANGLE, Schematic.PID_BACK_RIGHT_DRIVE, Schematic.PID_BACK_RIGHT_DISTANCE, 0, "Back Right");
